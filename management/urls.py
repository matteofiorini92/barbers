...
urlpatterns = [
    ...
    path('delete_treatment/<int:treatment_id>/',
         views.delete_treatment, name='delete_treatment'),
    ...
    path('delete_barber/<int:barber_id>/',
         views.delete_barber, name='delete_barber'),
    path('reservations/', views.list_of_reservations, name='reservations'),
]
